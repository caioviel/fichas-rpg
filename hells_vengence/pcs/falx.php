...
<title>Pathfinder :: Hell's Vengeance - Valerian Falx</title>
...
<div id="wrapper">
	<div id="aedram-container">
		<header>
			<h1>Valerian Falx <span id="cr">Level 3</span></h1>
			<h2>Sério. Seriamente sarcastico. Chifres, algumas escamas na pele e uma cauda. Barba sempre por fazer.</h2>

		</header>

		<section id="base-informations">
			<div class="image-area">
				<img id="character-image" src="../images/falx.png" alt="">
			</div>
			<div class="stats-area">
				<p>
					Male tiefling <a href="http://www.d20pfsrd.com/classes/core-classes/cleric" target="_blank">cleric of Asmodeus</a> (<a href="http://www.d20pfsrd.com/races/other-races/featured-races/arg-tiefling/fiendish-vessel-cleric-tiefling" target="_blank">fiendish vessel</a>) 3<br />
					LE Medium outsider (native)<br /><br />
					<strong>Init</strong> +0; <strong>Senses</strong>Darkvision 60 ft.; Perception +11<br />
